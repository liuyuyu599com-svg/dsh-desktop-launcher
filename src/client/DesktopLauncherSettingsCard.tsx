...
export interface DesktopLauncherSettingsCardState extends CardShell {
  ...
  /** Confirm gate for restart. */
  confirmRestart: FieldState
}
...
export class DesktopLauncherSettingsCardController {
  ...
  private projection(): DesktopLauncherSettingsCardState {
    return {
      ...
      confirmRestart: this.form.field('confirmRestart'),
    }
  }
...
export function DesktopLauncherSettingsCard(props: DesktopLauncherSettingsCardProps) {
  ...
  return (
    ...
    >
      ...
      />
      <BooleanField
        id="settings-desktop-launcher-confirm-restart"
        label={t('settings.confirmRestart')}
        hint={t('settings.confirmRestartHint')}
        inheritLabel={t('settings.inherit')}
        onLabel={t('settings.on')}
        offLabel={t('settings.off')}
        {...fieldProps}
        {...state.confirmRestart}
        onEdit={(text) => { props.edit('confirmRestart', text) }}
        onReset={() => { props.resetField('confirmRestart') }}
      />
    </PluginSettingsCard>
  )
}
