...
export const zh = {
  ...
  'settings.warning': '注意',
  'settings.shutdownSection': '一键关机 / 重启',
  'settings.confirmShutdown': '退出前确认',
  'settings.confirmShutdownHint': '关闭后点击按钮直接退出，不再弹出确认框。',
  'settings.confirmRestart': '重启前确认',
  'settings.confirmRestartHint': '关闭后点击重启按钮直接重启，不再弹出确认框。',
  'entry.label': '退出 DeepSeek Harness',
  'restart.label': '重启 DeepSeek Harness',
  'restart.title': '确认重启',
  'restart.description': '重启 DeepSeek Harness 会先结束再重新启动 dsh web 进程，当前会话与任务会中断，之后页面会自动恢复。确定要重启吗？',
  'restart.confirm': '重启',
...
export const en = {
  ...
  'settings.shutdownSection': 'One-click shutdown / restart',
  ...
  'settings.confirmRestart': 'Confirm before restart',
  'settings.confirmRestartHint': 'When off, the restart button restarts immediately without a confirm dialog.',
  'entry.label': 'Exit DeepSeek Harness',
  'restart.label': 'Restart DeepSeek Harness',
  'restart.title': 'Confirm restart',
  'restart.description': 'Restarting DeepSeek Harness stops and starts the dsh web process; the current session and tasks are interrupted, and the page recovers afterwards. Are you sure you want to restart?',
