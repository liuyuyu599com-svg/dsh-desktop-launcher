...
/**
 * Mount the floating power/restart buttons into document.body.
 * @param face - locale copy and the confirm gates.
 * @returns the disposer unmounting the buttons and removing the host element.
 */
export function mountShutdownButton(face: FloatingButtonFace): () => void {
  ...
  root.render(createElement(ShutdownEntry, {
    ...
    confirmRestart: face.confirmRestart,
  }))
  return () => {
    root.unmount()
    host.remove()
