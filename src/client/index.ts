...
export function apply(ctx: ClientContext): void {
  ...
  const confirmRestart = (): boolean => read()?.confirmRestart ?? true

  // Floating power/restart buttons: fixed bottom-right triggers that are
  // independent of the sidebar layout. Toggling the plugin off removes them.
